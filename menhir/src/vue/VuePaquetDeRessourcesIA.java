...
public class VuePaquetDeRessourcesIA extends VuePaquetDeRessourcesDeJoueur{
	...
	public VuePaquetDeRessourcesIA(
			PaquetDeRessourcesDeJoueur paquetDeRessourcesDeJoueur, Ressources r, boolean avancee, boolean speciale) {
			...
			if(speciale){
				if (paquetDeRessourcesDeJoueur.getPaquetsDeCartes().get("Cartes Chiens De Garde").get(0)!=null){
					vuesCartes[6]= new VueCarteChiensDeGarde(paquetDeRessourcesDeJoueur.getPaquetsDeCartes()
							.get("Cartes Chiens De Garde").get(0),r,80,80,true);
				}
				else{
					vuesCartes[7]= new VueCarteChamp(paquetDeRessourcesDeJoueur.getPaquetsDeCartes()
							.get("Cartes Taupes Geantes").get(0),r,80,80,true);
				}
			}
